let keyPresets = {
  white_sf: `["Esc",{x:0.5},"F1","F2","F3","F4",{x:0.5},"F5","F6","F7","F8",{x:0.5},"F9","F10","F11","F12",{x:0.5},"Delete"],
[{y:0.25},"~\\n\`","!\\n1","@\\n2","#\\n3","$\\n4","%\\n5","^\\n6","&\\n7","*\\n8","(\\n9",")\\n0","_\\n-","+\\n=",{w:2},"Backspace","End"],
[{w:1.5},"Tab","Q","W","E","R","T","Y","U","I","O","P","{\\n[","}\\n]",{w:1.5},"|\\n\\\\","PgUp"],
[{w:1.75},"Caps Lock","A","S","D","F","G","H","J","K","L",":\\n;","\\\"\\n'",{w:2.25},"Enter","PgDn"],
[{w:2.25},"Shift","Z","X","C","V","B","N","M","<\\n,",">\\n.","?\\n/",{w:1.75},"Shift","↑","Fn"],
[{w:1.5},"Ctrl",{x:0.75,w:1.5},"Alt",{a:7,w:7},"",{a:4,w:1.5},"Win",{x:0.75},"←","↓","→"]`,
  olivia_sf: `[{c:"#f1beb0",t:"#2b2b2b"},"Esc",{x:0.5,c:"#e1dbd1"},"F1","F2","F3","F4",{x:0.5,c:"#2b2b2b",t:"#f1beb0"},"F5","F6","F7","F8",{x:0.5,c:"#e1dbd1",t:"#2b2b2b"},"F9","F10","F11","F12",{x:0.5,c:"#2b2b2b",t:"#f1beb0"},"Delete"],
...
[{w:1.5},"Ctrl",{x:0.75,w:1.55},"Alt",{x:-0.05,c:"#f1beb0",t:"#000000",a:7,w:7},"",{c:"#2b2b2b",t:"#f1beb0",a:4,w:1.5},"Win",{x:0.75,c:"#f1beb0",t:"#2b2b2b"},"←","↓","→"]`,
  // white_ansi:
//   modo_dawn:`[{c:"#d36a7b",t:"#e8e8e8"},"Esc",{x:1,c:"#82878d"},"F1","F2","F3","F4",{x:0.5,c:"#515459"},"F5","F6","F7","F8",{x:0.5,c:"#82878d"},"F9","F10","F11","F12",{x:0.25,c:"#515459"},"PrtSc","Scroll Lock","Pause\\nBreak"],
// [{y:0.25},"~\\n\`",{c:"#e1dbd1",t:"#2b2b2b"},"!\\n1","@\\n2","#\\n3","$\\n4","%\\n5","^\\n6","&\\n7","*\\n8","(\\n9",")\\n0","_\\n-","+\\n=",{c:"#2b2b2b",t:"#f1beb0",w:2},"Backspace","Home"],
// [{w:1.5},"Tab",{c:"#e1dbd1",t:"#2b2b2b"},"Q","W","E","R","T","Y","U","I","O","P","{\\n[","}\\n]",{c:"#2b2b2b",t:"#f1beb0",w:1.5},"|\\n\\\\","PgUp"],
// [{w:1.75},"Caps Lock",{c:"#e1dbd1",t:"#2b2b2b"},"A","S","D",{n:true},"F","G","H",{n:true},"J","K","L",":\\n;","\\\"\\n'",{c:"#d36a7b",t:"#e8e8e8",w:2.25},"Enter","PgDn"],
// [{w:2.25},"Shift",{c:"#e1dbd1",t:"#2b2b2b"},"Z","X","C","V","B","N","M","<\\n,",">\\n.","?\\n/",{c:"#2b2b2b",t:"#f1beb0",w:1.75},"Shift",{c:"#d36a7b",t:"#e8e8e8"},"↑",{c:"#2b2b2b",t:"#f1beb0"},"End"],
// [{w:1.5},"Ctrl",{x:0.75,w:1.55},"Alt",{x:-0.05,c:"#f1beb0",t:"#000000",a:7,w:7},"",{c:"#2b2b2b",t:"#f1beb0",a:4,w:1.5},"Win",{x:0.75,c:"#f1beb0",t:"#2b2b2b"},"←","↓","→"]`,
  modo_wkltkl: `[{c:"#d36a7b",t:"#e8e8e8"},"Esc",{x:1,c:"#82878d"},"F1","F2","F3","F4",{x:0.5,c:"#515459"},"F5","F6","F7","F8",{x:0.5,c:"#82878d"},"F9","F10","F11","F12",{x:0.25,c:"#515459"},"PrtSc","Scroll Lock","Pause\\nBreak"],
...
[{w:1.5},"Ctrl",{x:1,w:1.5},"Alt",{c:"#d36a7b",a:7,w:7},"",{c:"#515459",a:4,w:1.5},"Alt",{x:1,w:1.5},"Ctrl",{x:0.25},"←","↓","→"]`,
  dracula_tkl: `[{c:"#bd93f9",t:"#282a36"},"Esc",{x:1,c:"#44475a",t:"#f8f8f2"},"F1","F2","F3","F4",{x:0.5,c:"#282a36"},"F5","F6","F7","F8",{x:0.5,c:"#44475a"},"F9","F10","F11","F12",{x:0.25,c:"#282a36"},"PrtSc","Scroll Lock","Pause\\nBreak"],
...
[{c:"#282a36",t:"#f1fa8c",w:1.5},"Ctrl",{t:"#ff79c6"},"Win",{t:"#bd93f9",w:1.5},"Alt",{c:"#bd93f9",t:"#f8f8f2",a:7,w:7},"",{c:"#282a36",t:"#bd93f9",a:4,w:1.5},"Alt",{t:"#ff79c6"},"Win",{t:"#f1fa8c",w:1.5},"Ctrl",{x:0.25,c:"#ff79c6",t:"#282a36"},"←",{c:"#bd93f9"},"↓",{c:"#8be9fd"},"→"]`,
  ezze_sxf: `[{c:"#fe588c"},"Esc",{c:"#9ba7b7",t:"#3f4754"},"!\\n1","@\\n2","#\\n3","$\\n4","%\\n5","^\\n6","&\\n7","*\\n8","(\\n9",")\\n0","_\\n-","+\\n=","\\\\\\n\\\\","~\\n\`",{c:"#3f4754",t:"#fe588c"},"Delete"],
...
[{w:1.5},"Ctrl",{x:0.75,w:1.5},"Alt",{c:"#fe588c",t:"#000000",a:7,w:7},"",{c:"#3f4754",t:"#fe588c",a:4,w:1.5},"Win",{x:0.75},"←","↓","→"]`,
  mizu_fullsize: `[{c:"#f8f7f3",t:"#243746"},"Esc",{x:1,c:"#b7d8eb"},"F1","F2","F3","F4",{x:0.5,c:"#243746",t:"#f8f7f3"},"F5","F6","F7","F8",{x:0.5,c:"#b7d8eb",t:"#243746"},"F9","F10","F11","F12",{x:0.25,c:"#243746",t:"#f8f7f3"},"PrtSc","Scroll Lock","Pause\\nBreak"],
...
[{c:"#243746",t:"#f8f7f3",w:1.25},"Ctrl",{w:1.25},"Win",{w:1.25},"Alt",{c:"#f8f7f3",t:"#243746",a:7,w:6.25},"",{c:"#243746",t:"#f8f7f3",a:4,w:1.25},"Alt",{w:1.25},"Win",{w:1.25},"Menu",{w:1.25},"Ctrl",{x:0.25,c:"#f8f7f3",t:"#243746"},"←","↓","→",{x:0.25,c:"#b7d8eb",t:"#243746",w:2},"0\\nIns",".\\nDel"]`,
  bow_fullsize: `["Esc",{x:1},"F1","F2","F3","F4",{x:0.5},"F5","F6","F7","F8",{x:0.5},"F9","F10","F11","F12",{x:0.25},"PrtSc","Scroll Lock","Pause\\nBreak"],
...
[{w:1.25},"Ctrl",{w:1.25},"Win",{w:1.25},"Alt",{a:7,w:6.25},"",{a:4,w:1.25},"Alt",{w:1.25},"Win",{w:1.25},"Menu",{w:1.25},"Ctrl",{x:0.25},"←","↓","→",{x:0.25,w:2},"0\\nIns",".\\nDel"]`,
  modelm: `[{c:"#b9afa3"},"Esc",{x:1,c:"#fdf5f3"},"F1","F2","F3","F4",{x:0.5,c:"#b9afa3"},"F5","F6","F7","F8",{x:0.5,c:"#fdf5f3"},"F9","F10","F11","F12",{x:0.25,c:"#b9afa3"},"PrtSc","Scroll Lock","Pause\\nBreak"],
